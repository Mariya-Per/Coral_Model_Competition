...
"""
# In this run I try out updated morphological relationships for the massive coral and new incident light formulae
#  I put rETRmax, alpha, beta, beta_rETR for massive corals - not updated values from last Peters fitting
# I change within-coral LAC from 0 to 0,5 and 1.0 for this run, just to check if it changes anything
